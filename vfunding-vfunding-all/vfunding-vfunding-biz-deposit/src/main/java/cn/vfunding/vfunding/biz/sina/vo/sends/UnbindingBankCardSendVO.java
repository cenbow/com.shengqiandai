...
public class UnbindingBankCardSendVO extends BaseSinaSendVO{
public UnbindingBankCardSendVO() {
	// TODO Auto-generated constructor stub
	super();
	this.setService("unbinding_bank_card");
	this.setVersion("1.0");
}
	...
	private String card_id;	//卡ID	String(32)	钱包系统卡ID，绑卡返回的ID	非空	2000011212
