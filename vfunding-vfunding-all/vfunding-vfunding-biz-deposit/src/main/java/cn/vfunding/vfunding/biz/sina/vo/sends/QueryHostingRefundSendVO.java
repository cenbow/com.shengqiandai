...
public class QueryHostingRefundSendVO extends BaseSinaSendVO{
public QueryHostingRefundSendVO() {
	// TODO Auto-generated constructor stub
	super();
	this.setService("query_hosting_refund");
	this.setVersion("1.0");
}
	...
	private String out_trade_no;	//退款订单号	String(32) 	商户网站交易订单号，商户内部保证唯一	可空	20131105154925 
