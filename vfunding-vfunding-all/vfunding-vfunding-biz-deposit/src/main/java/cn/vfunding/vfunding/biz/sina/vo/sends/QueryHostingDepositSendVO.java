...
public class QueryHostingDepositSendVO extends BaseSinaSendVO{
public QueryHostingDepositSendVO() {
	// TODO Auto-generated constructor stub
	super();
	this.setService("query_hosting_deposit");
	this.setVersion("1.0");
}
	...
	private String account_type;	//账户类型	String(16)	账户类型（基本户、保证金户）。默认基本户，见附录	可空	BASIC
