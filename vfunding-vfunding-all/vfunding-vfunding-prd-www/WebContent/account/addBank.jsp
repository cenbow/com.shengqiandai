				...
				<div class="rT box-shadow">
					...
					<div class="warm-tips">
						...
						<ul>
							...
							<li>3、建议您使用目前支持快捷支付的对应银行银行卡：中行、农行、建行、工行、招商、中信、民生、广发、兴业、光大、上海、华夏、平安、浦发。</li>
							<li>4、 下列银行，目前支持网银充值及提现，但不支持手机端充值：交行、邮储、北京。</li>
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#apply-now").on("click",function(){
				if('${loginedSession.realStatus}' != '1'){
					webUtil.jDialog.Modal('dialogRealName', 'dialogRealNameCont');
					return;
				}else{
					self.location.href = "/accountBank/toIcbcCardPage";
				}
			});
