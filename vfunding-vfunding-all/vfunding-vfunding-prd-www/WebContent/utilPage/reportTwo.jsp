...
<head>
    <meta charset="utf-8">
    <title>微积金-2015新春红包活动</title>
    	<link rel="stylesheet" type="text/css"
		href="${pageContext.request.contextPath}/css/rateUp.css" />
    <link rel="stylesheet" href="/css/jquery.fullPage.css">
    <link rel="stylesheet" href="/css/reportTwo.css">
...
<ul id="menu">
    <li data-menuanchor="page1" class="active"><a href="#page1">新春福利</a></li>
    <li data-menuanchor="page2"><a href="#page2">注册有礼</a></li>
    <li data-menuanchor="page3"><a href="#page3">推荐有礼</a></li>
    <li data-menuanchor="page4"><a href="#page4">投资有礼</a></li>
    <li data-menuanchor="page5"><a href="#page5">送电影票</a></li>
