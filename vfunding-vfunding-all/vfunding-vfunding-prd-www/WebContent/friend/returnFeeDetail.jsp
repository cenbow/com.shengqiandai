...
<!-- <script type="text/javascript" -->
<%-- 	src="${pageContext.request.contextPath}/js/friend/returnFeeDetail.js"></script> --%>
					...
					<div class="rTWrap">
						...
						<div class="returns">
							<table width="780" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td width="195" height="55">已返<span><fmt:formatNumber
												value="${edw.firstEarned +edw.firstWait }"
												pattern="#,##0.00#" /></span>元
									</td>
									<td width="195" height="35">已返<span><fmt:formatNumber
												value="${edw.secondEarned+edw.secondWait  }"
												pattern="#,##0.00#" /></span>元
									</td>
									<td width="195" height="35">已返<span><fmt:formatNumber
												value="${edw.thirdEarned+edw.thirdWait }"
												pattern="#,##0.00#" /></span>元
									</td>
									<td width="195" height="35">已返<span><fmt:formatNumber
												value="${edw.firstEarned+ edw.secondEarned+edw.thirdEarned+edw.firstWait+edw.secondWait+edw.thirdWait }"
												pattern="#,##0.00#" /></span>元
									</td>
								</tr>
						...
						<!-- <div class="fanliDetail">
							<table width="780" cellpadding="0" cellspacing="0"
								id="returnDetail">
								<tr>
									<td width="146" height="50" class="bt">预计到帐日</td>
									<td width="146" height="50" class="bt">投资日期</td>
									<td width="146" class="bt">投资人</td>
									<td width="146" class="bt">投资标名称</td>
									<td width="146" class="bt">投资金额</td>
									<td width="146" class="bt">返佣金额</td>
									<td width="146" class="bt">状态</td>
								</tr>
							</table>
