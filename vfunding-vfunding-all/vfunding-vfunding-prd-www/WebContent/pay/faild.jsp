...
<link rel="stylesheet" type="text/css"
	href="http://static.vfunding.cn/css/recharge-fail.css" />
				...
				<div class="rT">
					<div class="rTWrap">
						...
						<div class="sendEamil">
							...
							<div class="send">
								<p id="finishVerify">您的充值未成功，该充值通道暂时不顺畅,建议选择其它充值方式或稍后再试。</p>
							</div>
							<div class="goCheck">
								如有疑问， 您可以咨询 <span>&nbsp;&nbsp;&nbsp;&nbsp;<a href="" id="ceping"
									class="fontColor" target="_blank">在线客服</a>
								</span>
