...
'<P id=passStrong class="pswState"><EM class=st1>弱</EM><B class="progressImage prog0"></B><EM class=st2>强</EM></P>',
'<P id=passStrong class="pswState"><EM class=st1>弱</EM><B class="progressImage prog1"></B><EM class=st2>强</EM></P>',
'<P id=passStrong class="pswState"><EM class=st1>弱</EM><B class="progressImage prog2"></B><EM class=st2>强</EM></P>',
'<P id=passStrong class="pswState"><EM class=st1>弱</EM><B class="progressImage prog3"></B><EM class=st2>强</EM></P>'
							  ];
