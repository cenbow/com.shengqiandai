					...
					if (rows != null && rows.length > 0) {
						...
						for (var i = 0; i < rows.length; i++) {
							...
							if (rowContent.status == 1
								...
								tenderAction = '<a href="/borrow/borrowDetail/'
										+ rowContent.id
										+ '"	class="repaying huanColor" target="blank" style="margin:0 5px;">撮合成功';
							} else if (rowContent.status == 3
									&& rowContent.borrowIsRepay) {
								tenderAction = '<a href="/borrow/borrowDetail/'
										+ rowContent.id
							...
							if (rowContent.biaoType == 'fast') {
								var litpicPath = '<img src="../images/index/touxiang.png" height="72" width="72" />';
							} else if (rowContent.biaoType == 'huodong') {
								var litpicPath = '<img src="../images/index/huodong-small.png" height="72" width="72" />';
							} else if (rowContent.biaoType == 'feel') {
								var litpicPath = '<img src="../images/index/touxiang2.png" height="72" width="72" />';
							} else {
								var litpicPath = '<img src="../images/index/touxiang.png" height="72" width="72" />';
							}
