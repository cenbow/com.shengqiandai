...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/modifyPhoneSucceed.css" />
					...
					<div class="rTWrap">
						...
						<ol class="reg_step">
							<li class="step1"><span class="step_msg"> <i
									class="icons dot24">1</i> <span class="whiteColor">填写账单信息</span>
							</span></li>
							...
							<li class="step3"><span class="step_msg"> <i
									class="icons dot24">3</i> <span class="whiteColor"> 注册成功</span>
							</span></li>
						</ol>


						<div class="modifySucceess">您的手机已修改成功！</div>
