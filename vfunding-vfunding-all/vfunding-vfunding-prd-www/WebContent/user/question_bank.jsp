				...
				<div class="rT box-shadow">
					<div class="rTWrap">
						...
						<div class="pwdQue">
							...
							<form action="${pageContext.request.contextPath }/user/saveQuestion" name="pwdSafe" method="post" id="pwdAnswer">

								<table width="560" cellpadding="0" cellspacing="0" id="pwdSafe">
									<tr>
									...
									<tr>
										...
										<td width="470"><input type="text" id="answer" name="answer"/> <span
											class="answerTip"></span></td>
									</tr>
									<tr>
