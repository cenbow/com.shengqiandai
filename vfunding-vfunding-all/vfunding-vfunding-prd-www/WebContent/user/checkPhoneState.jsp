...
<script src="${pageContext.request.contextPath}/js/phoneState.js"></script>

<script src="${pageContext.request.contextPath}/js/getCodeByAddOrCheckStatePhone.js"></script>
</head>
			...
			<div class="rechargeTakeCash fr">
				<div class="rT">
					<div class="rTWrap">
						<div class="txTop">
							<b class="midLine"></b>
							<h2 class="zhcz">手机认证</h2>
							<a href="javascript:history.go(-1);" class="goBack">返回</a>
						</div>

						<div class="realname">

							<form id="newPhone" class="ui-form">
								<fieldset>
									<div class="ui-form-item">
										<label class="ui-label">手机号码：</label>
										<c:choose>
											<c:when test="${not empty loginedSession.phone }">
												<input type="text" class="ui-input" name="phone" id="mobile"
													value="${loginedSession.phone }" readonly="readonly" />
											</c:when>
											<c:otherwise>
												<input type="text" class="ui-input" name="phone" id="mobile" />
											</c:otherwise>
									...
									<div class="ui-form-item">
										<a href="javascript:getCodeByPhone('mobile');" id="phoneCode"
											class="mobileCheck">短信获取</a> <a href="javascript:;"
											id="voiceCode" class="voiceCheck"
									...
									<div class="ui-form-item">
										...
										<div style="margin-top: 28px;">
											<input type="submit" class="nextStep" hidefocus="true"
												value="提交">
										</div>
