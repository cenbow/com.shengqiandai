...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/modifyPwd.css" />
			...
			<div class="rechargeTakeCash fr">
				<div class="rT box-shadow">
					<div class="rTWrap">
						...
						<div class="modifyPwd">
							<form
								action="${pageContext.request.contextPath }/user/saveNewPassword"
								method="post" id="modifyPwd" class="ui-form">
								<fieldset>

									<div class="ui-form-item">
										<label class="ui-label pwdBefore"> 原密码： </label> <input
											type="password" class="ui-input" name="oldpassword"
											id="pwdBefore" value="${oldpassword }" />
										<c:if test="${empty oldpassword }">
											<p class="input_tip">请输入原密码</p>
										</c:if>
									</div>
									...
									<div class="ui-form-item">
										<label class="ui-label pwdNew"> 新密码： </label> <input
											type="password" class="ui-input" name="password" id="pwdNew"
											value="${password }" />
										<div class="psw-streng">
											<div></div>
										</div>
										<c:if test="${empty password }">
											<p class="input_tip">请输入新密码</p>
										</c:if>
									</div>
									...
									<div class="ui-form-item">
										<label class="ui-label pwdNew2"> 确认新密码： </label> <input
											type="password" class="ui-input" name="repassword"
											id="pwdNew2" value="${repassword }" />
										<c:if test="${empty repassword }">
