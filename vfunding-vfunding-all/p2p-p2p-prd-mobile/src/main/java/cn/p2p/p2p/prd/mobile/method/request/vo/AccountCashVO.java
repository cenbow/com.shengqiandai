...
public class AccountCashVO extends GeneralRequestVO{
	...
	private Integer isNotPayPassword;
	...
	public Integer getIsNotPayPassword() {
		return isNotPayPassword;
	}

	public void setIsNotPayPassword(Integer isNotPayPassword) {
		this.isNotPayPassword = isNotPayPassword;
	}
