...
public class WeekBorrowPawn extends BaseModel{
    private Integer id;
    ...
    private List<WeekBorrowPawnPic> weekBorrowPawnPicList;
    
    
    public List<WeekBorrowPawnPic> getWeekBorrowPawnPicList() {
		return weekBorrowPawnPicList;
	}

	public void setWeekBorrowPawnPicList(
			List<WeekBorrowPawnPic> weekBorrowPawnPicList) {
		this.weekBorrowPawnPicList = weekBorrowPawnPicList;
	}
