...
<body>
	<div id="index_layout">
		<div data-options="region:'north',href:'${ctx }/js/layout/north.jsp',border:false"
			style="height: 70px; overflow: hidden;" class=""></div>
		<div
			data-options="region:'west',href:'${ctx }/js/layout/west.jsp',split:true,iconCls:'icon-tip'"
			title="菜单导航" style="width: 200px; overflow: hidden;"></div>
		<div data-options="region:'center'" title="欢迎使用微积金数据平台"
