...
$(function() {
	...
	$(".kindsOfdate li").each(function() {
		$(this).click(function() {
			...
			if($('#searchType').val() == 0) { //项目
				if($("#type_").find("li").eq(0).attr('class')=='liColor'&&$("#detail1_").find("li").eq(0).attr('class')=='liColor'){
					$("#detail1_").find("li").eq(0).click();
				}
				if($("#type_").find("li").eq(0).attr('class')=='liColor'&&$("#detail1_").find("li").eq(1).attr('class')=='liColor'){
					$("#detail1_").find("li").eq(1).click();
				}
			} else {//待收
				if($("#type_").find("li").eq(1).attr('class')=='liColor'&&$("#detail2_").find("li").eq(0).attr('class')=='liColor'){
					$("#detail2_").find("li").eq(0).click();
				}
				if($("#type_").find("li").eq(1).attr('class')=='liColor'&&$("#detail2_").find("li").eq(1).attr('class')=='liColor'){
					$("#detail2_").find("li").eq(1).click();
				}
			}
		});
	})
