var img = {
	 ...
	 init:function(){
		...
		for(var i=0;i<img.imagebg_li.length;i++){
			...
			if(i!=0){
				img.small_pic_html.push("<li onclick='img.play("+i+")'><img width='145'  height='65' src='"+img.imagebg_li[i].getAttribute("data-sPic")+"' /></li>");
				img.imagebg.getElementsByTagName("li")[i].style.display ="none";
			}else{
				img.small_pic_html.push("<li onclick='img.play("+i+")' class='currently'><img width='145'  height='65' src='"+img.imagebg_li[i].getAttribute("data-sPic")+"' /></li>");
			}
