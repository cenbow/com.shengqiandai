	...
	<div data-options="region:'center',border:false" title=""
		...
		<form id="addoreditform" method="post" style="text-align: center;">
			...
			<table class="table table-hover table-condensed" style="text-align: center; ">
				<!-- 第一行 -->
				<tr style="text-align: center;">
					<th style="vertical-align: middle; text-align: right;">车主姓名:</th>
					<td style="vertical-align: middle;">
					...
					<th style="vertical-align: middle; text-align: right;">车主身份证:</th>
					<td style="vertical-align: middle;">
				...
				<!-- 第二行 -->
				<tr style="text-align: center;">
					<th style="vertical-align: middle; text-align: right;">车主手机号:</th>
					<td style="vertical-align: middle;">
