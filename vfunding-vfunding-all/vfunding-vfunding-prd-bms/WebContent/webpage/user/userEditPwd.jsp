...
<script type="text/javascript">
	$(function() {
		...
		$('#editCurrentUserPwdForm').form({
			url : '${pageContext.request.contextPath}/emp/editCurrentUserPwd',
			onSubmit : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		...
		<c:if test="${employee.loginName != null}">
			<form id="editCurrentUserPwdForm" method="post">
				<table class="table table-hover table-condensed">
					...
					<tr>
						<th>重复</th>
						<td><input name="newPwd" type="password" placeholder="请再次输入新密码" class="easyui-validatebox" data-options="required:true,validType:'eqPwd[\'#editCurrentUserPwdForm input[name=pwd]\']'"></td>
					</tr>
				</table>
			</form>
		</c:if>
