...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/sinadeposit/searchDeposit.js"></script>
...
<body class="easyui-layout" data-options="fit : true,border : false">
	<div data-options="region:'center',border:false" style="overflow: hidden;">
		<div style="margin:10px;">
			充值流水单号:<input type="text" id="condition" name="condition" style="width: 120px; height: 12px; margin: 0;" value=""/> 
			<c:if test="${canSearch==true }">
