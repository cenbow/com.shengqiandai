...
<script type="text/javascript">
	...
	$(function() {
		...
		addDayform = $('#addDayform').form({
			url : '/system/dayborrow/addDayBorrow',
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		<form id="addDayform" method="post" style="text-align: center;" enctype="multipart/form-data">
			<table class="table table-hover table-condensed"
				style="text-align: center; padding: 10px; margin-left: 35px; margin-top: 15px;">
				<tr style="text-align: center;">
					<th style="vertical-align: middle; text-align: right;">天标标题：</th>
				...
				<tr>
					<th style="vertical-align: middle; text-align: right;">有效期：</th>
					<td><input type="text" id="valid_time" name="valid_time" placeholder="请输入借款期限/天"
						data-options="required:true"
						class="easyui-validatebox" /></td>
				</tr>
				<tr style="height: 15px;">
