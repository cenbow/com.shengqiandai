...
*******************************************************************************/
var bmsUrl = '../../js/article/kindeditor-4.1.7/';
...
K.options = {
	...
	pluginsPath : bmsUrl+K.basePath + 'plugins/',
	themeType : 'default',
	langType : 'zh_CN',
	urlType : '',
	newlineTag : 'p',
...
function _create(expr, options) {
	...
	options.themesPath = _undef(options.themesPath, bmsUrl+options.basePath + 'themes/');
	options.langPath = _undef(options.langPath, options.basePath + 'lang/');
	options.pluginsPath = _undef(options.pluginsPath, bmsUrl+options.basePath + 'plugins/');
