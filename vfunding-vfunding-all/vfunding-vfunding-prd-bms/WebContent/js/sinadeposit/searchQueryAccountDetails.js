...
function queryDetail() {
	...
	showWait(true);
	$.ajax({
		url:baseUrl+"/searchQueryAccountDetails",
		data:data,
		async:true,
		cache:false,
		type:"post",
...
function showResult(json){
	obj = json.obj;
	if(obj.sinaResult.detailList){
		var str = getSinaValue(obj,"detailList");
		var list = str.split("|");
		var s = "";
		var table_s = "<table>";
		var table_e = "</table>";
...
//			+"。";
		...
		resultDiv.html(table_s+s+table_e);
	}else{
