...
public class PaymentInfo implements Serializable {
	...
	private String oid_partner = "201407311000001519"; // 商户编号
	private String sign_type = "MD5"; // 签名方式
	private String sign; // 签名
	private String busi_partner = "101001"; // 商户业务类型
	private String no_order; // 商户唯一订单号
	private String dt_order; // 商户订单时间
	private String name_goods="充值"; // 商品名称
	private String info_order; // 订单描述
	private String money_order; // 交易金额 单位为RMB-元
	private String notify_url = "/llPay/llPayAutoReceive/"; // 服务器异步通知地址
	private String url_return = "/llPay/llPayReceive/"; // 支付结束回显url
	private String app_request = "3"; // 请求应用标识 1：Android 2：ios 3：WAP
