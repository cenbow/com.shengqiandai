...
public class ImageUtil2 {
	...
	public static void main(String[] args) {
		...
		// 方法二：按高度和宽度缩放
		ImageUtil2.scale2("e:/abc.jpg", "e:/abc_scale2.jpg", 500, 300, true);// 测试OK
		...
		// 5-给图片添加文字水印：
		// 方法一：
		ImageUtil2.pressText("我是水印文字", "e:/abc.jpg", "e:/abc_pressText.jpg",
				"宋体", Font.BOLD, Color.white, 80, 0, 0, 0.5f);// 测试OK
		// 方法二：
		ImageUtil2.pressText2("我也是水印文字", "e:/abc.jpg", "e:/abc_pressText2.jpg",
				"黑体", 36, Color.white, 80, 0, 0, 0.5f);// 测试OK

		// 6-给图片添加图片水印：
		ImageUtil2.pressImage("e:/abc2.jpg", "e:/abc.jpg",
