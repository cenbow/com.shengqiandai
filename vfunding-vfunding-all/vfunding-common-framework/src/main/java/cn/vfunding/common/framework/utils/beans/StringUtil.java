...
public class StringUtil extends org.apache.commons.lang.StringUtils {
								...
								if (null != v) {// 是json格式的
									...
									if (null != map && !map.isEmpty()) {
										for (String key : map.keySet()) {
											BeanUtils.forceSetProperty(o, key,
													map.get(key));
										}
									}
									valueList.add(o);
	 ...
	 * @param source
	 *            原号码
	 * @return 1234*****6789 2014年5月8日 liuyijun
	 */
	...
	public static void main(String[] args) {
		/*
		 * String m = "013817464985"; // m=m.substring(3, 7); m =
		 * m.replaceAll(m.substring(4, 8), "****");
		 * 
		 * System.out.println(m);
		 */

		// System.out.println(getFirstLetter("中国工商银行").toLowerCase());

		/*
		 * String re = getFirstLetter("中国工商银行").toLowerCase(); String pre =
		 * re.substring(0, re.length() - 1);
		 * 
		 * System.out.println(pre);
		 */
		System.out.println(isChinese("凤飞飞"));

		System.out.println(StringUtil.converterToFirstSpell("淅川县"));

		System.out.println(StringUtil.converterToSpell("淅川县"));
