package cn.vfunding.common.framework.utils.rest;
...
import cn.vfunding.common.framework.utils.cache.web.annotation.CacheController;
...
import cn.vfunding.common.framework.utils.rest.annotation.RestParam;
import cn.vfunding.common.framework.utils.rest.annotation.RestParams;
		...
		for (Method method : methods) {
			...
			if (rem != null) {
				...
				RequestMethod[] requestMethods = rem.method();// requestMapping
																// 上的方法定义
				if (EmptyUtil.isNotEmpty(requestMethods)) {
				...
				restDescriptor.setProduceMeta(method.getReturnType().toString()
