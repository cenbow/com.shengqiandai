...
import cn.vfunding.common.framework.easyui.page.utils.ReturnResult;
...
public class BeanUtils extends org.apache.commons.beanutils.BeanUtils {
	...
	public static <T> void copyProperties(T source, T target,
		...
		if (EmptyUtil.isEmpty(ignoreProperties)) {
			try {
	...
	/**
	 * 将Map中的数据copy到target对象中，如果涉及到时间类型的数据，必须是date类型
	 * 
	 * @author LiuJun
	 * 
	 * */
	public static <T> void changeMapToSimpleBean(Map source, T target) {
	...
	/**
	 * 创建 PageResult Bean，如果传入的list为空
	 * 
	 * @param lists
	 * @return
	 */
	public static <T> PageResult<T> getPageResultBean(String... errors) {
		...
		return getPageResultBean(null, 0, maps);
	}

	/**
	 * 创建 PageResult Bean，如果传入的list为空，则new一个新的list集合
	 * 
	 * @param lists
	 * @return
	 */
	public static <T> PageResult<T> getPageResultBean(List<T> lists) {
		return getPageResultBean(lists, lists.size(), null);
	}
	 ...
	 * @return
	 */
	public static <T> PageResult<T> getPageResultBean(Map<String, String> errors) {
		return getPageResultBean(null, 0, errors);
	}
	...
	public static <T> PageResult<T> getPageResultBean(List<T> lists,
			Integer total) {
		return getPageResultBean(lists, total, null);
	}
	 ...
	 */
	public static <T> PageResult<T> getPageResultBean(List<T> lists,
			Integer total, Map<String, String> errors) {
	 ...
	 * @return
	 */
	public static <T> ReturnResult<T> getReturnResultBean(String... errors) {
		Map<String, String> maps = null;
		if (EmptyUtil.isNotEmpty(errors)) {
			maps = new HashMap<String, String>();
			for (String error : errors) {
		...
		return getReturnResultBean(null, 0, maps, null);
	}
	 ...
	 * @return
	 */
	public static <T> ReturnResult<T> getReturnResultBean(String error) {
		return getReturnResultBean(null, 0, null, error);
	}
	 ...
	 * @return
	 */
	public static <T> ReturnResult<T> getReturnResultBean(List<T> lists) {
		return getReturnResultBean(lists, lists.size(), null, null);
	}
	 ...
	 */
	public static <T> ReturnResult<T> getReturnResultBean(List<T> lists,
			Integer total, Map<String, String> errors, String error) {
		if (EmptyUtil.isEmpty(lists)) {
			lists = new ArrayList<T>();
		}
		ReturnResult<T> result = new ReturnResult<T>();
		result.setEntities(lists);
