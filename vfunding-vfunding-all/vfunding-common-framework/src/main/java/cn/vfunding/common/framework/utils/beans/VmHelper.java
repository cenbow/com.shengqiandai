...
public class VmHelper {
	...
	private VmHelper() {
		try {
			...
			tmsMethod = systemMXBean.getClass().getDeclaredMethod(
					"getTotalPhysicalMemorySize");
			tmsMethod.setAccessible(true);
			fmsMethod = systemMXBean.getClass().getDeclaredMethod(
					"getFreePhysicalMemorySize");
			fmsMethod.setAccessible(true);
			sclMethod = systemMXBean.getClass().getDeclaredMethod(
					"getSystemCpuLoad");
			sclMethod.setAccessible(true);
			pclMethod = systemMXBean.getClass().getDeclaredMethod(
					"getProcessCpuLoad");
	...
	public Double getLoadIndex() {
		try {
			double mem = ((this.getTotalMemorySize().doubleValue() - this
					.getFreeMemorySize().doubleValue()) / this
					.getTotalMemorySize().doubleValue());
